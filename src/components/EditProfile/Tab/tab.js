                ...
                <div className="container">
                    <div className="row plr--70 padding-control-edit-wrapper pl_md--0 pr_md--0 pl_sm--0 pr_sm--0">
                        <div className="col-12 d-flex justify-content-between mb--30 align-items-center">
                            ...
                            <a href="author.html" className="btn btn-primary ml--10"><i className="feather-eye mr--5" /> Preview</a>
                        </div>
                    </div>
                    <div className="row plr--70 padding-control-edit-wrapper pl_md--0 pr_md--0 pl_sm--0 pr_sm--0">
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            ...
                            <nav className="left-nav rbt-sticky-top-adjust-five">
                                <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button className="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true"><i className="feather-edit" />Edit Profile Image</button>
                                    <button className="nav-link" id="nav-home-tabs" data-bs-toggle="tab" data-bs-target="#nav-homes" type="button" role="tab" aria-controls="nav-homes" aria-selected="false"><i className="feather-user" />Personal Information</button>
                                    <button className="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false"> <i className="feather-unlock" />Change Password</button>
                                    <button className="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false"><i className="feather-bell" />Notification Setting</button>
                                </div>
                            </nav>
                            {/* End tabs area */}
                        </div>
                                                ...
                                                <div className="button-area">
                                                    <div className="brows-file-wrapper">
                                                        ...
                                                        <label htmlFor="fatima" title="No File Choosen">
                                                            <fors className="text-center color-white">Upload Profile</fors>
                                                        </label>
                                                    </div>
                                                ...
                                                <div className="button-area">
                                                    <div className="brows-file-wrapper">
                                                        ...
                                                        <label htmlFor="nipa" title="No File Choosen">
                                                            <fors className="text-center color-white">Upload Cover</fors>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
