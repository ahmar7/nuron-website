                        ...
                        <div className="offset-4 col-lg-4">
                            <div className="form-wrapper-one">
                                ...
                                <div className="mb-5">
                                    ...
                                    <label className="rn-check-box-label" htmlFor="exampleCheck1">I agree to the <a href="privacy-policy.html">privacy policy</a> </label>
                                </div>
                                <div className="mb-5">
                                    <button className="btn btn-large btn-primary">Send</button>
                                </div>
                                <span className="mt--20 notice">Note: We will send a password to your email</span>
                            </div>
                        </div>
                    </div>
                </div>
