                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-lg-5 col-md-12 col-sm-12 mt_md--50 mt_sm--60">
                            <div className="rn-pd-content-area">
                                ...
                                <span className="bid">Height bid <span className="price">0.11wETH</span></span>
                                ...
                                <a className="btn btn-primary-alta" href="#">Unlockable content included</a>
                                <div className="rn-bid-details">
                                                        ...
                                                        <div className="property-wrapper">
                                                            ...
                                                            {propertyData.map((item, key) => (
                                                                ...
                                                                <div className="pd-property-inner">
                                                                    <span className="color-body type">{item.type}</span>
                                                                    <span className="color-white value">{item.value}</span>
                                                                </div>
                                                            ))}
                                                            {/* single property End */}
                                                        </div>
                                    ...
                                    <div className="place-bet-area">
                                            ...
                                            <div className="bid-list winning-bid">
                                                ...
                                                <div className="top-seller-inner-one">
                                                    <div className="top-seller-wrapper">
                                                        ...
                                                        <div className="top-seller-content">
                                                            <span className="heighest-bid">Heighest bid <a href="#">Atif
                                                                aslam</a></span>
                                                            <span className="count-number">
                                                                0.115wETH
                                                            </span>
                                        ...
                                        <button type="button" className="btn btn-primary-alta mt--30" data-bs-toggle="modal" data-bs-target="#placebidModal">Place a Bid</button>
                                    </div>
                                </div>
                            </div>
                        </div>
